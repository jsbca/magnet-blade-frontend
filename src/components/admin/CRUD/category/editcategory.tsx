      ...
      <div className="adminBody">
        ...
        <main className="adminMain">
          <div className="pageHeader">
            <h1 className="pageTitle">Edit Category</h1>
            <div className="breadcrumb">Dashboard &gt; Category &gt; Edit Category</div>
          </div>
          ...
          <div className="card">
            ...
            <input className="input" defaultValue="Fridge Magnets" />
            ...
            <div className="actionsRow">
              <button className="primaryBtn">Update Category</button>
